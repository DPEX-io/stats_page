...
function AppHeaderLinks({ mode, small, clickCloseIcon }) {
  return (
    <div className="App-header-links">
      {small &&
        <div className="App-header-links-header">
          ...
          <NavLink exact activeClassName="active" className="App-header-link-main" to="/">
            <img src={logoIcon} alt="DPEX Logo" />
          </NavLink>
        </div>
      }
      ...
      <div className="App-header-link-container">
        <NavLink to="/polygon" className="nav-link">Polygon</NavLink>
      </div>
    </div>
  )
}
    ...
    <Switch>
      {
        mode && <div className={cx("App", mode)}>
          ...
          <div className="nav">
            <div className="nav-left">
              ...
              <a href="/"  className="nav-logo">
                {/* <img style={{width:"100%", maxWidth:'60px'}} src={mode == 'dark' ? darkLogoIcon : lightLogoIcon} /> */}
                <img style={{width:"100%", maxWidth:'60px'}} src={darkLogoIcon} />
            ...
            <div className="nav-right">
              <a href="https://app.dpex.io" target="_blank" className="nav-link">APP</a>
              <a href="https://docs.dpex.io" target="_blank" className="nav-link">DOCS</a>
          ...
          <div className="content">
            ...
            <Route exact path="/polygon" render={(props) => (
              <Avalanche {...props} mode={mode} />
            )} />

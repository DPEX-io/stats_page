...
import { addresses, getAddress, ARBITRUM, AVALANCHE, MAINNET } from './addresses'
...
const FIRST_DATE_TS = parseInt(+(new Date(2023, 1, 1)) / 1000)
...
export async function queryEarnData(chainName, account) {
  ...
  if (chainId === ARBITRUM) {
    ...
    depositTokens = ['0x3eD4c2D63DEf617F436EB031BAcAE16f478f3B00','0x5e4a7Bf3E07608ac5805C74144f2149518044435','0xF76b35FE83e67ba521626c3ff2C4DA274551d2D8', '0xAa47Ad77ebA36302ef37f0C975777C7Bb9a129b6','0xf9dAd14fD43665187fA568949313A901c202c5d9','0xd3a829a4C9938F54072bAd827780aFf15335Ec39']
    rewardTrackersForDepositBalances = ['0xF76b35FE83e67ba521626c3ff2C4DA274551d2D8', '0xF76b35FE83e67ba521626c3ff2C4DA274551d2D8', '0xAa47Ad77ebA36302ef37f0C975777C7Bb9a129b6', '0x6f7f6e88c36Ee4e06c9d2e1C511d91bC789643CE', '0x6f7f6e88c36Ee4e06c9d2e1C511d91bC789643CE', '0xDa65b4E72B4fb3D6203456B0DBA5830545D4eA9e']
    rewardTrackersForStakingInfo = ['0xF76b35FE83e67ba521626c3ff2C4DA274551d2D8', '0xAa47Ad77ebA36302ef37f0C975777C7Bb9a129b6', '0x6f7f6e88c36Ee4e06c9d2e1C511d91bC789643CE', '0xDa65b4E72B4fb3D6203456B0DBA5830545D4eA9e', '0xDa65b4E72B4fb3D6203456B0DBA5830545D4eA9e']
 }
...
export const tokenDecimals = {
  ...
  "0x45c32fa6df82ead1e2ef74d17b76547eddfaff89": 18, // MIM
...
const knownSwapSources = {
  ...
  polygon: {
    '0xB50E0e14D3Ce8b1d6e1A2aE432480b5089eA32db': 'DPEX Router', // Router
    '0xaB770Aa6Ce1fD9305c25E0C3AB03FD8C53e4c880': 'DPEX OrderBook', // Orderbook
    '0x838FAf89D602DfDeFFe2EE12Ad93C455E56BCe68': 'DPEX PositionManager A', // PositionManager old
    // '0x838FAf89D602DfDeFFe2EE12Ad93C455E56BCe68': 'DPEX PositionManager B', // PositionManager
    // '0x838FAf89D602DfDeFFe2EE12Ad93C455E56BCe68': 'DPEX PositionManager C', // PositionManager 12 oct 2022
    // '0x838FAf89D602DfDeFFe2EE12Ad93C455E56BCe68': 'DPEX PositionRouter C', // PositionRouter 12 oct 2022
    '0x94D9262386285109D52fa319C62B161f32D84F3b': 'DPEX OrderExecutor', // OrderExecutor
    '0xe35f76d6e97a1b08233d767f17c4108f8f6806a8': 'DPEX FastPriceFeed A', // FastPriceFeed
    '0xe35f76d6e97a1b08233d767f17c4108f8f6806a8': 'DPEX PositionExecutor', // Position Executor
    '0xc4729e56b831d74bbc18797e0e17a295fa77488c': 'Yak',
    '0x409e377a7affb1fd3369cfc24880ad58895d1dd9': 'Dodo',
    '0x6352a56caadc4f1e25cd6c75970fa768a3304e64': 'OpenOcean',
    '0x7c5c4af1618220c090a6863175de47afb20fa9df': 'Gelato',
...
function getChainSubgraph(chainName) {
  return chainName === "arbitrum" ? "davidblockdev/amx-avalanche-stats" : "davidblockdev/amx-avalanche-stats"
}
...
export function useGraph(querySource, { subgraph = null, subgraphUrl = null, chainName = "arbitrum" } = {}) {
  ...
  if (!subgraphUrl) {
    if (!subgraph) {
      ...
      subgraph = 'https://api.thegraph.com/subgraphs/name/dpex-io/core'
    }
    subgraphUrl = 'https://api.thegraph.com/subgraphs/name/dpex-io/core'
  }
...
export function useGlpData({ from = FIRST_DATE_TS, to = NOW_TS, chainName = "arbitrum" } = {}) {
  ...
  const glpChartData = useMemo(() => {
    ...
    let prevGlpSupply
    let prevAum
    let ret = sortBy(data.mvlpStats, item => item[timestampProp]).filter(item => item[timestampProp] % 86400 === 0).reduce((memo, item) => {
      const last = memo[memo.length - 1]

      const aum = Number(item.aumInUsdm) / 1e18
      const glpSupply = Number(item.mvlpSupply) / 1e18
...
export function useGlpPerformanceData(glpData, feesData, { from = FIRST_DATE_TS, chainName = "arbitrum" } = {}) {
  ...
  const [avaxPrices] = useCoingeckoPrices('MATIC', { from })

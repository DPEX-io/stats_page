  ...
  return (
    <div className="Home">
        ...
        <div className="page-title-block">
          ...
          {lastSubgraphBlock && lastBlock &&
            <p className={cx('page-description', { warning: isObsolete })}>
              ...
              &nbsp;at block <a rel="noreferrer" target="_blank" href={`https://polygonscan.com/block/${lastSubgraphBlock.number}`} rel="noreferrer">{lastSubgraphBlock.number}</a>
            </p>
          }
          {
      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell stats">
          {totalAum ? <>
            <div className="total-stat-label">DPLP Pool</div>
            <div className="total-stat-value">
        ...
        <div className="chart-cell">
          <ChartWrapper title="AUM & DPLP Supply" loading={glpLoading} data={glpData} csvFields={[{ key: 'aum' }, { key: 'glpSupply' }]}>
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" strokeWidth={2} dot={false} dataKey="glpSupply" stackId="a" name="DPLP Supply" stroke={COLORS[1]} />
              </LineChart>
            </ResponsiveContainer>
          </ChartWrapper>
        </div>
          ...
          >
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpPerformanceData} syncId="syncGlp">
                ...
                <Line dot={false} isAnimationActive={false} type="monotone" unit="%" dataKey="performanceLpAvaxCollectedFees" name="% LP MATIC-USDC" stroke={COLORS[3]} />
          ...
          >
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpPerformanceData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} dot={false} dataKey="glpPrice" name="DPLP Price" stroke={COLORS[1]} />
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={2} dot={false} dataKey="glpPlusFees" name="DPLP w/ fees" stroke={COLORS[3]} />
                ...
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} dot={false} dataKey="lpAvaxPrice" name="LP MATIC-USDC" stroke={COLORS[5]} />
              </LineChart>
            </ResponsiveContainer>
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[3]}}>DPLP with fees</span> is based on DPLP share of fees received and excluding esMMX rewards<br/>
                <span style={{color: COLORS[2]}}>Index Price</span> is a basket 16.6% MATIC, 16.6% BTC, 16.6% ETH and 50% USDC rebalanced once&nbsp;a&nbsp;day
              </p>
            </div>
          </ChartWrapper>
        </div>
        ...
        <div className="chart-cell">
           <GenericChart
              ...
              items={[{ key: 'ETH' }, { key: 'WBTC' }, { key: 'USDC' }, { key: 'USDT' }, { key: 'USDC' }, { key: 'LINK' }, { key: 'AAVE' }, { key: 'MATIC' }]}
              type="Line"
        ...
        <div className="chart-cell">
           <GenericChart
              ...
              items={[
                ...
                { key: 'uniqueMintBurnCount', name: 'Mint & Burn DPLP' }
              ]}
              type="Composed"
            />
        </div>

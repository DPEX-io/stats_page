  ...
  return (
    <div className="Home">
      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell stats">
          {totalAum ? <>
            <div className="total-stat-label">MLP Pool</div>
            <div className="total-stat-value">
        ...
        <div className="chart-cell">
          ...
          >
            ...
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[3]}}>Mlp with fees</span> is based on MLP share of fees received and excluding esMMX rewards<br/>
        ...
        <div className="chart-cell">
           <GenericChart
              ...
              description="Formula = Daily Fees / MLP Pool * 365 days * 100"
              type="Composed"
            />
        </div>
        <div className="chart-cell">
          <GenericChart
            ...
            description="Formula = Daily Volume / MLP Pool * 100"
            type="Composed"
          />
        </div>
        <div className="chart-cell">
          <GenericChart
            ...
            items={[
              ...
              { key: 'uniqueMintBurnCount', name: 'Mint & Burn MLP' }
            ]}
            type="Composed"
          />
        </div>
        ...
        <div className="chart-cell">
          <GenericChart
            ...
            tooltipFormatter={tooltipFormatterNumber}
            tooltipLabelFormatter={tooltipLabelFormatterUnits}
            items={[{ key: 'actionSwapCount', name: 'Swaps' }, { key: 'actionMarginCount', name: 'Margin trading' }, { key: 'actionMintBurnCount', name: 'Mint & Burn MLP' }]}
            type="Composed"
          />
        </div>
        <div className="chart-cell">
